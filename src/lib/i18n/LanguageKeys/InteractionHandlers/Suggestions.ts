...
export const MissingManageMessagesPermissions = T('interaction-handlers:suggestions/missingManageMessagesPermissions');
export const MissingAllowedRoles = T('interaction-handlers:suggestions/missingAllowedRoles');
