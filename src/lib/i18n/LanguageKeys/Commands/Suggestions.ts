...
export const ResolveNotConfigured = T('commands/suggestions:resolveNotConfigured');
export const ResolveSuggestionArchived = T('commands/suggestions:resolveSuggestionArchived');
export const ResolveSuggestionIdDoesNotExist = T('commands/suggestions:resolveSuggestionIdDoesNotExist');
export const ResolveSuggestionMessageDeleted = T('commands/suggestions:resolveSuggestionMessageDeleted');
export const ResolveNoReason = T('commands/suggestions:resolveNoReason');
export const ResolveSuccess = FT<{ id: string }>('commands/suggestions:resolveSuccess');
export const ResolveFailure = FT<{ id: string }>('commands/suggestions:resolveFailure');
